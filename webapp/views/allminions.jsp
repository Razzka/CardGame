...
<html ng-app="myApp">
  ...
  <body ng-controller="MinionController as ctrl">
    <minion ng-repeat="item in ctrl.minions" m=item></minion>
    ...
    <script src="<c:url value='/resources/js/directives/minion.js' />"></script>
    <script src="<c:url value='/resources/js/app.js' />"></script>
    <script src="<c:url value='/resources/js/controller/minionController.js' />"></script>
